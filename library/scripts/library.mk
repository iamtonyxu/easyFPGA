...
VIVADO_OPTS += -nojournal -nolog -tempDir $(LIBRARY_NAME)
...
.PHONY: all intel intel_dep xilinx xilinx_dep clean clean-all gui
...
gui: xilinx_dep component.xml
	vivado $(VIVADO_OPTS) $(LIBRARY_NAME).xpr
